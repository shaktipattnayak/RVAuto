...
public class CustomReport implements IReporter {
    ...
    private static String outFilename = "vSoft Automation-results.html";
    ...
    protected void writeStackTrace(Throwable throwable) {
        ...
        //writer.print(Utils.stackTrace(throwable, true)[0].substring(0, 150));
        String messsageTo = Utils.stackTrace(throwable, true)[0];
        int beginIndex = messsageTo.indexOf(':');
        int endIndex = messsageTo.indexOf(')') + 1;
        messsageTo= messsageTo.subSequence(beginIndex, endIndex).toString();
        writer.print(messsageTo);
        writer.print("</div>");
    }
